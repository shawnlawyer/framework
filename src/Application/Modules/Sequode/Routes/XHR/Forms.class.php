...
class Forms {
    ...
    public static function component($type, $_model_id, $map_key, $dom_id){
        ...
        return DOMElementKitJS::placeForm(ModuleForm::render(static::$registry_key, __FUNCTION__, array($type, $map_key)), $dom_id);
    }
    public static function componentSettings($type, $member, $_model_id, $dom_id){
        ...
        return DOMElementKitJS::placeForm(ModuleForm::render(static::$registry_key, __FUNCTION__, array($type, $member, $dom_id)), $dom_id);
    }
